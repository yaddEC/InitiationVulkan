...
Debug::Debug(VkInstance& VulkInstance)
{
	this->VulkInstance = &VulkInstance;
}

void Debug::Destroy()
{
	if (enableValidationLayers) {
		DestroyDebugUtilsMessengerEXT(*VulkInstance, debugMessenger, nullptr);
	}
}
...
void Debug::setupDebugMessenger()
{
	...
	if (CreateDebugUtilsMessengerEXT(*VulkInstance, &createInfo, nullptr, &debugMessenger) != VK_SUCCESS) {
